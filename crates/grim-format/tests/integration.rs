...
fn convert_to_grim_then_grim_provider_round_trips_tensor_payload() {
    ...
    convert_to_grim(gguf_path_str, grim_path_str, "gfx1100", 4.0, 0, None, None, None, None)
...
fn convert_to_grim_produces_deterministic_payload_for_same_input() {
    ...
    convert_to_grim(gguf_str, a_str, "gfx1100", 4.0, 0, None, None, None, None).unwrap();
    convert_to_grim(gguf_str, b_str, "gfx1100", 4.0, 0, None, None, None, None).unwrap();
