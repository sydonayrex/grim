//! Thin wrapper around `Llama` for openelm uses a Llama-style transformer.
...
impl ModelConfig for OpenElmConfig {
    fn name(&self) -> &str {
        "openelm"
    }
...
impl OpenElm {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: OpenElmConfig) -> Result<Self> {
