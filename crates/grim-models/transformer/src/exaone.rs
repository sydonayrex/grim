//! Thin wrapper around `Llama` for exaone uses a Llama-style transformer.
...
impl ModelConfig for ExaoneConfig {
    fn name(&self) -> &str {
        "exaone"
    }
...
impl Exaone {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: ExaoneConfig) -> Result<Self> {
