//! Thin wrapper around `Llama` for starcoder uses a Llama-style transformer.
...
impl ModelConfig for StarcoderConfig {
    fn name(&self) -> &str {
        "starcoder"
    }
...
pub struct Starcoder {
    pub cfg: StarcoderConfig,
    pub device: Device,
    pub inner: Llama,
}

impl Starcoder {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: StarcoderConfig) -> Result<Self> {
