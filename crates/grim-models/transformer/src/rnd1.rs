//! Thin wrapper around `Llama` for rnd1 uses a Llama-style transformer.
...
impl ModelConfig for Rnd1Config {
    fn name(&self) -> &str {
        "rnd1"
    }
...
impl Rnd1 {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: Rnd1Config) -> Result<Self> {
