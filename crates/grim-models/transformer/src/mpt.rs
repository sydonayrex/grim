//! Thin wrapper around `Llama` for mpt uses a Llama-style transformer.
...
impl ModelConfig for MptConfig {
    fn name(&self) -> &str {
        "mpt"
    }
...
impl Mpt {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: MptConfig) -> Result<Self> {
