//! Thin wrapper around `Llama` for olmo2 uses a Llama-style transformer.
...
impl ModelConfig for Olmo2Config {
    fn name(&self) -> &str {
        "olmo2"
    }
...
impl Olmo2 {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: Olmo2Config) -> Result<Self> {
