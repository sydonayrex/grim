...
impl Default for Glm4MoeLiteConfig {
    fn default() -> Self {
        Self {
            vocab_size: 151552,
            hidden_size: 2048,
...
impl ModelConfig for Glm4MoeLiteConfig {
    fn name(&self) -> &str {
        "glm4_moe_lite"
    }
...
impl Glm4LiteMoeBlock {
    pub fn load(ws: &WeightSource<'_>, cfg: &Glm4MoeLiteConfig) -> Result<Self> {
...
impl Glm4MoeLiteBlock {
    pub fn load(ws: &WeightSource<'_>, cfg: &Glm4MoeLiteConfig, _tp: TensorParallelConfig) -> Result<Self> {
        ...
        let moe = Glm4LiteMoeBlock::load(&ws.scoped("mlp"), cfg)?;
...
pub struct Glm4MoeLite {
    ...
    pub layers: Vec<Glm4MoeLiteBlock>,
    pub norm: RmsNorm,
    pub output: Linear,
}
...
impl Glm4MoeLite {
    pub fn load_tp(
        ...
        for i in 0..num_layers_to_load {
            ...
            layers.push(Glm4MoeLiteBlock::load(&layer_ws, &cfg, tp)?);
        }
    ...
    pub fn random(device: Device, cfg: Glm4MoeLiteConfig) -> Self {
...
mod tests {
    ...
    #[test]
    fn test_glm4_moe_lite_config_defaults() {
        let cfg = Glm4MoeLiteConfig::default();
        assert_eq!(cfg.name(), "glm4_moe_lite");
    ...
    fn test_glm4_moe_lite_forward_and_session_state() {
        ...
        let model = Glm4MoeLite::random(Device::Cpu, cfg);
