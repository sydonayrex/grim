//! Thin wrapper around `Llama` for mistral3 uses a Llama-style transformer.
...
impl ModelConfig for Mistral3Config {
    fn name(&self) -> &str {
        "mistral3"
    }
...
pub struct Mistral3 {
    pub cfg: Mistral3Config,
    pub device: Device,
    pub inner: Llama,
}

impl Mistral3 {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: Mistral3Config) -> Result<Self> {
