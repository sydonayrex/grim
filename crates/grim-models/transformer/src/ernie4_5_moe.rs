//! Thin wrapper around `Llama` for ernie4_5_moe uses a Llama-style transformer.
...
impl ModelConfig for Ernie45MoeConfig {
    fn name(&self) -> &str {
        "ernie4_5_moe"
    }
...
impl Ernie45Moe {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: Ernie45MoeConfig) -> Result<Self> {
