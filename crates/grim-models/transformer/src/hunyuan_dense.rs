//! Thin wrapper around `Llama` for hunyuan_dense uses a Llama-style transformer.
...
impl ModelConfig for HunyuanDenseConfig {
    fn name(&self) -> &str {
        "hunyuan_dense"
    }
...
pub struct HunyuanDense {
    pub cfg: HunyuanDenseConfig,
    pub device: Device,
    pub inner: Llama,
}

impl HunyuanDense {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: HunyuanDenseConfig) -> Result<Self> {
...
impl CausalLm for HunyuanDense {
