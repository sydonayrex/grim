//! Thin wrapper around `Llama` for granite uses a Llama-style transformer.
...
pub struct Granite {
    pub cfg: GraniteConfig,
    pub device: Device,
    pub inner: Llama,
}

impl Granite {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: GraniteConfig) -> Result<Self> {
