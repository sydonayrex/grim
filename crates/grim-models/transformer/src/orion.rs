//! Thin wrapper around `Llama` for orion uses a Llama-style transformer.
...
impl ModelConfig for OrionConfig {
    fn name(&self) -> &str {
        "orion"
    }
...
impl Orion {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: OrionConfig) -> Result<Self> {
