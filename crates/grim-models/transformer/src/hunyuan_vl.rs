//! Thin wrapper around `Llama` for hunyuan_vl uses a Llama-style transformer.
...
impl HunyuanVl {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: HunyuanVlConfig) -> Result<Self> {
