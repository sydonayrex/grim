//! Thin wrapper around `Llama` for grok uses a Llama-style transformer.
...
impl ModelConfig for GrokConfig {
    fn name(&self) -> &str {
        "grok"
    }
...
impl Grok {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: GrokConfig) -> Result<Self> {
