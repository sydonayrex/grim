//! Thin wrapper around `Llama` for xverse uses a Llama-style transformer.
...
impl ModelConfig for XverseConfig {
    fn name(&self) -> &str {
        "xverse"
    }
...
pub struct Xverse {
    pub cfg: XverseConfig,
    pub device: Device,
    pub inner: Llama,
}

impl Xverse {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: XverseConfig) -> Result<Self> {
