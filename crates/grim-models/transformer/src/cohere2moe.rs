//! Thin wrapper around `Llama` for cohere2moe uses a Llama-style transformer.
...
impl ModelConfig for Cohere2MoeConfig {
    fn name(&self) -> &str {
        "cohere2moe"
    }
...
pub struct Cohere2Moe {
    pub cfg: Cohere2MoeConfig,
    pub device: Device,
    pub inner: Llama,
}

impl Cohere2Moe {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: Cohere2MoeConfig) -> Result<Self> {
