//! Thin wrapper around `Llama` for cohere2 uses a Llama-style transformer.
...
impl ModelConfig for Cohere2Config {
    fn name(&self) -> &str {
        "cohere2"
    }
...
pub struct Cohere2 {
    pub cfg: Cohere2Config,
    pub device: Device,
    pub inner: Llama,
}

impl Cohere2 {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: Cohere2Config) -> Result<Self> {
