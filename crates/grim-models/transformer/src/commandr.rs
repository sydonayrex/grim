//! Thin wrapper around `Llama` for commandr uses a Llama-style transformer.
...
impl CommandR {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: CommandRConfig) -> Result<Self> {
