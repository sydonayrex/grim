//! Thin wrapper around `Llama` for lladamoe uses a Llama-style transformer.
...
impl ModelConfig for LladaMoeConfig {
    fn name(&self) -> &str {
        "lladamoe"
    }
...
pub struct LladaMoe {
    pub cfg: LladaMoeConfig,
    pub device: Device,
    pub inner: Llama,
}

impl LladaMoe {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: LladaMoeConfig) -> Result<Self> {
