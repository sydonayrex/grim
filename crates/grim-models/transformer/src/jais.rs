//! Thin wrapper around `Llama` for jais uses a Llama-style transformer.
...
impl ModelConfig for JaisConfig {
    fn name(&self) -> &str {
        "jais"
    }
...
impl Jais {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: JaisConfig) -> Result<Self> {
