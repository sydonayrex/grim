//! Thin wrapper around `Llama` for wav_tokenizer_dec uses a Llama-style transformer.
...
impl WavTokenizerDec {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: WavTokenizerDecConfig) -> Result<Self> {
