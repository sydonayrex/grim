//! Thin wrapper around `Llama` for baichuan uses a Llama-style transformer.
...
impl ModelConfig for BaichuanConfig {
    fn name(&self) -> &str {
        "baichuan"
    }
...
pub struct Baichuan {
    pub cfg: BaichuanConfig,
    pub device: Device,
    pub inner: Llama,
}

impl Baichuan {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: BaichuanConfig) -> Result<Self> {
