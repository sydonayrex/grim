...
impl ModelConfig for DFlashConfig {
    fn name(&self) -> &str {
        "dflash"
    }
...
impl DFlash {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: DFlashConfig) -> Result<Self> {
