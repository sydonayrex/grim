//! Thin wrapper around `Llama` for bailingmoe uses a Llama-style transformer.
...
impl ModelConfig for BailingMoeConfig {
    fn name(&self) -> &str {
        "bailingmoe"
    }
...
pub struct BailingMoe {
    pub cfg: BailingMoeConfig,
    pub device: Device,
    pub inner: Llama,
}

impl BailingMoe {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: BailingMoeConfig) -> Result<Self> {
