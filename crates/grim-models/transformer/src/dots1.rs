//! Thin wrapper around `Llama` for dots1 uses a Llama-style transformer.
...
impl ModelConfig for Dots1Config {
    fn name(&self) -> &str {
        "dots1"
    }
...
impl Dots1 {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: Dots1Config) -> Result<Self> {
