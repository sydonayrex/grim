//! Thin wrapper around `Llama` for hunyuan_moe uses a Llama-style transformer.
...
impl ModelConfig for HunyuanMoeConfig {
    fn name(&self) -> &str {
        "hunyuan_moe"
    }
...
pub struct HunyuanMoe {
    pub cfg: HunyuanMoeConfig,
    pub device: Device,
    pub inner: Llama,
}

impl HunyuanMoe {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: HunyuanMoeConfig) -> Result<Self> {
