//! Thin wrapper around `Llama` for smallthinker uses a Llama-style transformer.
...
impl ModelConfig for SmallThinkerConfig {
    fn name(&self) -> &str {
        "smallthinker"
    }
...
pub struct SmallThinker {
    pub cfg: SmallThinkerConfig,
    pub device: Device,
    pub inner: Llama,
}

impl SmallThinker {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: SmallThinkerConfig) -> Result<Self> {
...
impl CausalLm for SmallThinker {
