//! Thin wrapper around `Llama` for deepseek2 uses a Llama-style transformer.
...
impl DeepSeek2 {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: DeepSeek2Config) -> Result<Self> {
