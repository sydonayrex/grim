//! Thin wrapper around `Llama` for dream uses a Llama-style transformer.
...
impl ModelConfig for DreamConfig {
    fn name(&self) -> &str {
        "dream"
    }
...
impl Dream {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: DreamConfig) -> Result<Self> {
