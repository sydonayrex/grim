//! Thin wrapper around `Llama` for ernie45 uses a Llama-style transformer.
...
impl ModelConfig for Ernie45Config {
    fn name(&self) -> &str {
        "ernie45"
    }
...
pub struct Ernie45 {
    pub cfg: Ernie45Config,
    pub device: Device,
    pub inner: Llama,
}

impl Ernie45 {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: Ernie45Config) -> Result<Self> {
