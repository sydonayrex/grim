...
impl ModelConfig for GraniteMoeConfig {
    fn name(&self) -> &str {
        "granite_moe"
    }
...
pub struct GraniteMoe {
    pub cfg: GraniteMoeConfig,
    pub device: Device,
    pub inner: Llama,
}

impl GraniteMoe {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: GraniteMoeConfig) -> Result<Self> {
