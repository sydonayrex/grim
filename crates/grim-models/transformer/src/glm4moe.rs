...
impl ModelConfig for Glm4MoeConfig {
    fn name(&self) -> &str {
        "glm4moe"
    }
...
pub struct Glm4Moe {
    pub cfg: Glm4MoeConfig,
    pub device: Device,
    pub inner: Llama,
}

impl Glm4Moe {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: Glm4MoeConfig) -> Result<Self> {
