//! Thin wrapper around `Llama` for talkie uses a Llama-style transformer.
...
impl ModelConfig for TalkieConfig {
    fn name(&self) -> &str {
        "talkie"
    }
...
pub struct Talkie {
    pub cfg: TalkieConfig,
    pub device: Device,
    pub inner: Llama,
}

impl Talkie {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: TalkieConfig) -> Result<Self> {
