//! Thin wrapper around `Llama` for nemotron_hmoe uses a Llama-style transformer.
...
impl NemotronHMoe {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: NemotronHMoeConfig) -> Result<Self> {
