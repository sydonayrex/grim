...
impl ModelConfig for MiniMaxM2Config {
    fn name(&self) -> &str {
        "minimax_m2"
    }
...
pub struct MiniMaxM2 {
    pub cfg: MiniMaxM2Config,
    pub device: Device,
    pub inner: Llama,
}

impl MiniMaxM2 {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: MiniMaxM2Config) -> Result<Self> {
