//! Thin wrapper around `Llama` for llama4 uses a Llama-style transformer.
...
impl ModelConfig for Llama4Config {
    fn name(&self) -> &str {
        "llama4"
    }
...
pub struct Llama4 {
    pub cfg: Llama4Config,
    pub device: Device,
    pub inner: Llama,
}

impl Llama4 {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: Llama4Config) -> Result<Self> {
