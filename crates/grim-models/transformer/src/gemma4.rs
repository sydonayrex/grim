//! Thin wrapper around `Llama` for gemma4 uses a Llama-style transformer.
...
impl ModelConfig for Gemma4Config {
    fn name(&self) -> &str {
        "gemma4"
    }
...
impl Gemma4 {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: Gemma4Config) -> Result<Self> {
