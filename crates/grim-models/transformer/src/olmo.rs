//! Thin wrapper around `Llama` for olmo uses a Llama-style transformer.
...
impl ModelConfig for OlmoConfig {
    fn name(&self) -> &str {
        "olmo"
    }
...
impl Olmo {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: OlmoConfig) -> Result<Self> {
