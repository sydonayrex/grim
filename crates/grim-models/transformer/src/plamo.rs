//! Thin wrapper around `Llama` for plamo uses a Llama-style transformer.
...
impl ModelConfig for PlamoConfig {
    fn name(&self) -> &str {
        "plamo"
    }
...
impl Plamo {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: PlamoConfig) -> Result<Self> {
