//! Thin wrapper around `Llama` for seed_oss uses a Llama-style transformer.
...
impl ModelConfig for SeedOssConfig {
    fn name(&self) -> &str {
        "seed_oss"
    }
...
pub struct SeedOss {
    pub cfg: SeedOssConfig,
    pub device: Device,
    pub inner: Llama,
}

impl SeedOss {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: SeedOssConfig) -> Result<Self> {
