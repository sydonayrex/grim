//! Thin wrapper around `Llama` for qwen uses a Llama-style transformer.
...
impl Qwen {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: QwenConfig) -> Result<Self> {
