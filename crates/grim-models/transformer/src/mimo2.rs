//! Thin wrapper around `Llama` for mimo2 uses a Llama-style transformer.
...
impl ModelConfig for Mimo2Config {
    fn name(&self) -> &str {
        "mimo2"
    }
...
impl Mimo2 {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: Mimo2Config) -> Result<Self> {
