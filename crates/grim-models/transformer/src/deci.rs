//! Thin wrapper around `Llama` for deci uses a Llama-style transformer.
...
impl ModelConfig for DeciConfig {
    fn name(&self) -> &str {
        "deci"
    }
...
impl Deci {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: DeciConfig) -> Result<Self> {
