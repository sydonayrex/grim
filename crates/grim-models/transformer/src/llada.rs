//! Thin wrapper around `Llama` for llada uses a Llama-style transformer.
...
impl ModelConfig for LladaConfig {
    fn name(&self) -> &str {
        "llada"
    }
...
impl Llada {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: LladaConfig) -> Result<Self> {
