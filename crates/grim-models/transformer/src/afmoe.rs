//! Thin wrapper around `Llama` for afmoe uses a Llama-style transformer.
...
impl ModelConfig for AfMoeConfig {
    fn name(&self) -> &str {
        "afmoe"
    }
...
impl AfMoe {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: AfMoeConfig) -> Result<Self> {
