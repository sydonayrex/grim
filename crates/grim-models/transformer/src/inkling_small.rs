...
impl Default for InklingSmallConfig {
    fn default() -> Self {
        Self {
            vocab_size: 32000,
            hidden_size: 1024,
...
impl InklingSmallBlock {
    pub fn load(ws: &WeightSource<'_>, cfg: &InklingSmallConfig) -> Result<Self> {
...
pub struct InklingSmall {
    ...
    pub layers: Vec<InklingSmallBlock>,
    pub norm: RmsNorm,
    pub output: Linear,
}
...
impl InklingSmall {
    ...
    pub fn load_tp(
        ...
        for i in 0..cfg.num_hidden_layers {
            ...
            let block = InklingSmallBlock::load(&layer_ws, &cfg)?;
            layers.push(block);
        }
