//! Thin wrapper around `Llama` for gemma_embedding uses a Llama-style transformer.
...
impl ModelConfig for GemmaEmbeddingConfig {
    fn name(&self) -> &str {
        "gemma_embedding"
    }
...
pub struct GemmaEmbedding {
    pub cfg: GemmaEmbeddingConfig,
    pub device: Device,
    pub inner: Llama,
}

impl GemmaEmbedding {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: GemmaEmbeddingConfig) -> Result<Self> {
...
impl CausalLm for GemmaEmbedding {
