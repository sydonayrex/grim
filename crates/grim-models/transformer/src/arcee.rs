//! Thin wrapper around `Llama` for arcee uses a Llama-style transformer.
...
impl ModelConfig for ArceeConfig {
    fn name(&self) -> &str {
        "arcee"
    }
...
impl Arcee {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: ArceeConfig) -> Result<Self> {
