//! Thin wrapper around `Llama` for mistral4 uses a Llama-style transformer.
...
impl ModelConfig for Mistral4Config {
    fn name(&self) -> &str {
        "mistral4"
    }
...
pub struct Mistral4 {
    pub cfg: Mistral4Config,
    pub device: Device,
    pub inner: Llama,
}

impl Mistral4 {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: Mistral4Config) -> Result<Self> {
