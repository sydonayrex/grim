//! Thin wrapper around `Llama` for bailingmoe2 uses a Llama-style transformer.
...
impl ModelConfig for BailingMoe2Config {
    fn name(&self) -> &str {
        "bailingmoe2"
    }
...
pub struct BailingMoe2 {
    pub cfg: BailingMoe2Config,
    pub device: Device,
    pub inner: Llama,
}

impl BailingMoe2 {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: BailingMoe2Config) -> Result<Self> {
