//! Thin wrapper around `Llama` for gemma4_assistant uses a Llama-style transformer.
...
impl ModelConfig for Gemma4AssistantConfig {
    fn name(&self) -> &str {
        "gemma4_assistant"
    }
...
impl Gemma4Assistant {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: Gemma4AssistantConfig) -> Result<Self> {
...
impl Model for Gemma4Assistant {
...
impl CausalLm for Gemma4Assistant {
