//! Thin wrapper around `Llama` for starcoder2 uses a Llama-style transformer.
...
impl ModelConfig for Starcoder2Config {
    fn name(&self) -> &str {
        "starcoder2"
    }
...
pub struct Starcoder2 {
    pub cfg: Starcoder2Config,
    pub device: Device,
    pub inner: Llama,
}

impl Starcoder2 {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: Starcoder2Config) -> Result<Self> {
