//! Thin wrapper around `Llama` for internlm2 uses a Llama-style transformer.
...
impl ModelConfig for InternLm2Config {
    fn name(&self) -> &str {
        "internlm2"
    }
...
pub struct InternLm2 {
    pub cfg: InternLm2Config,
    pub device: Device,
    pub inner: Llama,
}

impl InternLm2 {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: InternLm2Config) -> Result<Self> {
