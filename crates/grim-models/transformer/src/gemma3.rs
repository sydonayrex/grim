//! Thin wrapper around `Llama` for gemma3 uses a Llama-style transformer.
...
impl ModelConfig for Gemma3Config {
    fn name(&self) -> &str {
        "gemma3"
    }
...
pub struct Gemma3 {
    pub cfg: Gemma3Config,
    pub device: Device,
    pub inner: Llama,
}

impl Gemma3 {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: Gemma3Config) -> Result<Self> {
