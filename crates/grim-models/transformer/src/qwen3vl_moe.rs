//! Thin wrapper around `Llama` for qwen3vl_moe uses a Llama-style transformer.
...
impl ModelConfig for Qwen3VlMoeConfig {
    fn name(&self) -> &str {
        "qwen3vl_moe"
    }
...
pub struct Qwen3VlMoe {
    pub cfg: Qwen3VlMoeConfig,
    pub device: Device,
    pub inner: Llama,
}

impl Qwen3VlMoe {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: Qwen3VlMoeConfig) -> Result<Self> {
