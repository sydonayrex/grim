//! Thin wrapper around `Llama` for plm uses a Llama-style transformer.
...
impl ModelConfig for PlmConfig {
    fn name(&self) -> &str {
        "plm"
    }
...
impl Plm {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: PlmConfig) -> Result<Self> {
