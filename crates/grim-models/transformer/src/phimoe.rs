//! Thin wrapper around `Llama` for phimoe uses a Llama-style transformer.
...
impl ModelConfig for PhiMoeConfig {
    fn name(&self) -> &str {
        "phimoe"
    }
...
impl PhiMoe {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: PhiConfig) -> Result<Self> {
