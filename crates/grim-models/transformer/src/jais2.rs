//! Thin wrapper around `Llama` for jais2 uses a Llama-style transformer.
...
impl ModelConfig for Jais2Config {
    fn name(&self) -> &str {
        "jais2"
    }
...
impl Jais2 {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: Jais2Config) -> Result<Self> {
