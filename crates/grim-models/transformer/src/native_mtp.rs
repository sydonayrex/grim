...
/// Qwen3.8-Flash-Next model with native 4B MTP head - predicts additional tokens
/// in the same forward pass for zero-config speculative acceleration.
...
impl Qwen38FlashNextMtp {
    pub fn new(base: crate::qwen38_flash_next::Qwen38FlashNext, depth: usize) -> Self {
        Self { base, depth }
    }
}
