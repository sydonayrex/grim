//! Thin wrapper around `Llama` for chatglm uses a Llama-style transformer.
...
impl ModelConfig for ChatGlmConfig {
    fn name(&self) -> &str {
        "chatglm"
    }
...
pub struct ChatGlm {
    pub cfg: ChatGlmConfig,
    pub device: Device,
    pub inner: Llama,
}

impl ChatGlm {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: ChatGlmConfig) -> Result<Self> {
