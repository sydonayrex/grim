//! Thin wrapper around `Llama` for step35 uses a Llama-style transformer.
...
impl ModelConfig for Step35Config {
    fn name(&self) -> &str {
        "step35"
    }
...
pub struct Step35 {
    pub cfg: Step35Config,
    pub device: Device,
    pub inner: Llama,
}

impl Step35 {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: Step35Config) -> Result<Self> {
