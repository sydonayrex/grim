//! Thin wrapper around `Llama` for eurobert uses a Llama-style transformer.
...
impl ModelConfig for EurobertConfig {
    fn name(&self) -> &str {
        "eurobert"
    }
...
pub struct Eurobert {
    pub cfg: EurobertConfig,
    pub device: Device,
    pub inner: Llama,
}

impl Eurobert {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: EurobertConfig) -> Result<Self> {
