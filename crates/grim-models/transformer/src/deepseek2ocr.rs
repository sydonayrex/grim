//! Thin wrapper around `Llama` for deepseek2ocr uses a Llama-style transformer.
...
impl ModelConfig for DeepSeek2OcrConfig {
    fn name(&self) -> &str {
        "deepseek2ocr"
    }
...
pub struct DeepSeek2Ocr {
    pub cfg: DeepSeek2OcrConfig,
    pub device: Device,
    pub inner: Llama,
}

impl DeepSeek2Ocr {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: DeepSeek2OcrConfig) -> Result<Self> {
...
impl CausalLm for DeepSeek2Ocr {
