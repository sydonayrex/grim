//! Thin wrapper around `Llama` for nemotron uses a Llama-style transformer.
...
impl ModelConfig for NemotronConfig {
    fn name(&self) -> &str {
        "nemotron"
    }
...
impl Nemotron {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: NemotronConfig) -> Result<Self> {
