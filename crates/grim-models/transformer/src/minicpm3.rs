//! Thin wrapper around `Llama` for minicpm3 uses a Llama-style transformer.
...
impl ModelConfig for MiniCpm3Config {
    fn name(&self) -> &str {
        "minicpm3"
    }
...
pub struct MiniCpm3 {
    pub cfg: MiniCpm3Config,
    pub device: Device,
    pub inner: Llama,
}

impl MiniCpm3 {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: MiniCpm3Config) -> Result<Self> {
