//! Thin wrapper around `Llama` for plamo3 uses a Llama-style transformer.
...
impl ModelConfig for Plamo3Config {
    fn name(&self) -> &str {
        "plamo3"
    }
...
pub struct Plamo3 {
    pub cfg: Plamo3Config,
    pub device: Device,
    pub inner: Llama,
}

impl Plamo3 {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: Plamo3Config) -> Result<Self> {
