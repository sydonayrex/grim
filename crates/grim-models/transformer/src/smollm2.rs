//! Thin wrapper around `Llama` for smollm2 uses a Llama-style transformer.
...
impl ModelConfig for SmolLm2Config {
    fn name(&self) -> &str {
        "smollm2"
    }
...
pub struct SmolLm2 {
    pub cfg: SmolLm2Config,
    pub device: Device,
    pub inner: Llama,
}

impl SmolLm2 {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: SmolLm2Config) -> Result<Self> {
