//! Thin wrapper around `Llama` for glm4 uses a Llama-style transformer.
...
impl ModelConfig for Glm4Config {
    fn name(&self) -> &str {
        "glm4"
    }
...
impl Glm4 {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: Glm4Config) -> Result<Self> {
