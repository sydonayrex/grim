...
impl ModelConfig for KimiLinearConfig {
    fn name(&self) -> &str {
        "kimi_linear"
    }
...
pub struct KimiLinear {
    pub cfg: KimiLinearConfig,
    pub device: Device,
    pub inner: Llama,
}

impl KimiLinear {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: KimiLinearConfig) -> Result<Self> {
