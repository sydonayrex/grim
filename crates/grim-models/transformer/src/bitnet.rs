//! Thin wrapper around `Llama` for bitnet uses a Llama-style transformer.
...
impl ModelConfig for BitNetConfig {
    fn name(&self) -> &str {
        "bitnet"
    }
...
impl BitNet {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: BitNetConfig) -> Result<Self> {
