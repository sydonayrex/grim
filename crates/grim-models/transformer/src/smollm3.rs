//! Thin wrapper around `Llama` for smollm3 uses a Llama-style transformer.
...
impl ModelConfig for SmolLm3Config {
    fn name(&self) -> &str {
        "smollm3"
    }
...
pub struct SmolLm3 {
    pub cfg: SmolLm3Config,
    pub device: Device,
    pub inner: Llama,
}

impl SmolLm3 {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: SmolLm3Config) -> Result<Self> {
