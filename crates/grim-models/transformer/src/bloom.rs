//! Thin wrapper around `Llama` for bloom uses a Llama-style transformer.

use grim_core::error::Result;
use grim_core::model::{AdapterHandle, CausalLm, Model, ModelConfig};
use grim_core::session::SessionT;
use grim_nn::TensorParallelConfig;
use grim_tensor::{ArithType, Device, Tensor};

use crate::configs::BloomConfig;
...
impl Bloom {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: BloomConfig) -> Result<Self> {
