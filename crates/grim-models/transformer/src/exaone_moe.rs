//! Thin wrapper around `Llama` for exaone_moe uses a Llama-style transformer.
...
impl ModelConfig for ExaoneMoeConfig {
    fn name(&self) -> &str {
        "exaone_moe"
    }
...
pub struct ExaoneMoe {
    pub cfg: ExaoneMoeConfig,
    pub device: Device,
    pub inner: Llama,
}

impl ExaoneMoe {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: ExaoneMoeConfig) -> Result<Self> {
