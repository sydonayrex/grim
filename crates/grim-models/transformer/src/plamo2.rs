//! Thin wrapper around `Llama` for plamo2 uses a Llama-style transformer.
...
impl ModelConfig for Plamo2Config {
    fn name(&self) -> &str {
        "plamo2"
    }
...
pub struct Plamo2 {
    pub cfg: Plamo2Config,
    pub device: Device,
    pub inner: Llama,
}

impl Plamo2 {
    pub fn load(device: Device, ws: &grim_nn::WeightSource<'_>, cfg: Plamo2Config) -> Result<Self> {
