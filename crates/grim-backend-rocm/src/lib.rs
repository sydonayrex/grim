...
// alignment + kv_to_block_major + resolve_weight_layout etc.). Re-exported
// here so existing call sites (and the lib tests in lib_internal_tests)
// see the same names they did before.
