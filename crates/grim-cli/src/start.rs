...
pub async fn cmd_start(
    ...
    let (program, mut cmd_args) = match client {
        ClientIntegration::Hermes => ("hermes", vec!["--model", &model_name]),
        ClientIntegration::Openclaw => ("openclaw", vec!["--model", &model_name]),
        ClientIntegration::Claw => ("claude-code", vec!["--model", &model_name]),
        ClientIntegration::Codex => ("codex", vec!["--model", &model_name]),
        ClientIntegration::Antigravity => ("antigravity", vec!["--model", &model_name]),
        ClientIntegration::Zcode => ("zcode", vec!["--model", &model_name]),
    };
