...
fn kernels() -> Vec<(&'static str, String)> {
    vec![
        ...
        ("rmsnorm_backward", load_kernel("rmsnorm_backward")),
        ...
        ("sub", load_kernel("sub")),
        ("add_scalar", load_kernel("add_scalar")),
        ("sub_scalar", load_kernel("sub_scalar")),
        ("div_scalar", load_kernel("div_scalar")),
        ("reduce_sum", load_kernel("reduce_sum")),
        ...
        (
            ...
            load_kernel("fused_dequant_gemm_w8a8_fp8"),
        ),
        (
            "fused_dequant_gemm_w8a8_int8",
            load_kernel("fused_dequant_gemm_w8a8_int8"),
        ),
        ...
        ("mla_decode", load_kernel("mla_decode")),
...
fn main() {
    ...
    println!("cargo:rerun-if-changed=kernels/rmsnorm_backward.comp");
    ...
    println!("cargo:rerun-if-changed=kernels/mla_decode.comp");
