    ...
    pub fn build_start_training_request(
        ...
        let body = serde_json::json!({
            ...
            "training_mode": match training_mode {
                ...
                TrainingMode::RsLora => "RsLora",
                TrainingMode::Dora => "Dora",
                TrainingMode::LoftQ => "LoftQ",
                TrainingMode::Orpo => "Orpo",
                TrainingMode::Dpo => "Dpo",
                TrainingMode::Kto => "Kto",
                TrainingMode::SimPo => "SimPo",
                TrainingMode::Grpo => "Grpo",
                TrainingMode::SoulEater => "SoulEater",
                TrainingMode::OmniGrad => "OmniGrad",
                TrainingMode::Scythe1 => "Scythe1",
